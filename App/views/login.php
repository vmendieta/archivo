...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="../../app/views/assets/font-awesome/css/font-awesome.min.css">
         <link rel="stylesheet" href="../../app/views/assets/css/style.css">
		<link rel="stylesheet" href="../../app/views/assets/css/form-elements.css">
        ...
        <link rel="shortcut icon" href="../../../app/views/assets/ico/favicon.png">
    ...
    <body>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="index" method="post" class="login-form" id="login-form">
        ...
        <!-- Javascript -->
        <script src="../../app/views/assets/js/jquery-1.11.1.min.js"></script>
        <script src="../../app/views/assets/bootstrap/js/bootstrap.min.js"></script>
        <script src="../../app/views/assets/js/jquery.backstretch.min.js"></script>
        <script src="../../app/views/assets/js/scripts2.js"></script>
        
        <!--[if lt IE 10]>
            <script src="../../app/views/assets/js/placeholder.js"></script>
        <![endif]-->
